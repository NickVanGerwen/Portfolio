...
function Home() {
    ...
    return (
        <>
            ...
            {/* Nav Bar */}
            <nav id="aboutme" class="navbar navbar-expand-lg navbar-black bg-black fixed-top" style={{ overflowX: 'hiddem', paddingLeft: '20px', paddingRight: '20px', width: '100%', opacity: '90%', backgroundColor: 'black' }}>
                <Link to="section1" smooth={true} duration={500} style={{ cursor: 'pointer', color: 'white', fontSize: '20px', paddingRight: '20px' }}>Nick van Gerwen</Link>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav" style={{ color: 'white' }}>
                        ...
                        <li class="nav-item" style={{ paddingLeft: '10px', paddingRight: '10px', paddingTop: '3px' }}>
                            <Link to="section2" style={{ cursor: 'pointer' }} offset={-50} smooth={true} duration={500}>Serious games</Link>
                        </li>
                        <li class="nav-item" style={{ paddingLeft: '10px', paddingRight: '10px', paddingTop: '3px' }}>
                            <Link to="section3" style={{ cursor: 'pointer' }} offset={-50} smooth={true} duration={500}>Personal projects</Link>
                        </li>
                        <li class="nav-item" style={{ paddingLeft: '10px', paddingRight: '10px', paddingTop: '3px' }}>
                            <Link to="section4" style={{ cursor: 'pointer' }} offset={-50} smooth={true} duration={500}>Game jam games</Link>
                        </li>
                        <li class="nav-item" style={{ paddingLeft: '10px', paddingRight: '10px', paddingTop: '3px' }}>
            ...
            <div id="section1" style={{ paddingTop: '0', display: 'flex', justifyContent: 'center', width: '100%' }}>
                <p className="HeaderContainer" style={{ fontWeight: 600, textAlign: 'center', fontSize: '48px', backgroundColor: '#211c1c', color: 'white', width: '100%', margin: '0', paddingBottom: '20px', paddingTop: '50px' }}>About Me</p>
            </div>
            <div className='Background' style={{ margin: '0', backgroundColor: '#3d3d3d', textAlign: 'center', color: 'black', height: '100%', width: '100vw' }}>
                ...
                <div id="section2" style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
                    <p className="HeaderContainer" style={{ fontWeight: 600, textAlign: 'center', fontSize: '48px', backgroundColor: '#211c1c', color: 'white', width: '100%', margin: '0', paddingTop: '10px' }}
                    >Serious Games</p>
                </div>
                <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
                    <p className="HeaderContainer" style={{ textAlign: 'center', fontSize: '18px', backgroundColor: '#211c1c', color: 'white', width: '100%', margin: '0', paddingBottom: '20px' }}
                    >These are some games I worked on with the goal of research and dissemination</p>
                </div>

                <div style={{ display: 'flex', justifyContent: 'center', marginTop: '25px' }}>
                    {/* VR eyetracking */}
                    <div class="GameContainer" style={{ marginRight: '10px' }}>
