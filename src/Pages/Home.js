                ...
                <div style={{ display: 'flex', justifyContent: 'center', marginTop: '40px' }}>
                    <div style={{ marginRight: '10px' }}>
                        <div style={{ paddingTop: '15px', fontSize: '28px', backgroundColor: 'black', width: '560px', height: '175px', color: 'white', border: '5px solid white' }}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'center', marginTop: '40px' }}>
                                <a href="https://www.youtube.com/watch?v=hnQDXada8EA&ab_channel=nickvangerwen" target="_blank" rel="noopener noreferrer">video</a>
                            </div>
                        </div>
                    ...
                    <div>
                        <div style={{ paddingTop: '15px', fontSize: '28px', backgroundColor: 'black', width: '560px', height: '175px', color: 'white', border: '5px solid white' }}>
                            Water You Doing?
                        <div style={{ display: 'flex', justifyContent: 'center', marginTop: '40px' }}>
                            <a href="https://youtu.be/aNN6NGJJU9I" target="_blank" rel="noopener noreferrer">video</a>
                        </div>
                        </div>
